# -*- coding: utf-8 -*-
"""Tests for `CatCellCoverage` package."""

import random

import pytest

from CatCellCoverage import CatCellCoverage
...
def test_sum_numbers(generate_numbers):
    ...
    our_result = CatCellCoverage.sum_numbers(generate_numbers)
...
def test_max_number(generate_numbers):
    ...
    our_result = CatCellCoverage.max_number(generate_numbers)
